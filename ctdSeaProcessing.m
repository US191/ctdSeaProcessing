...
uicontrol(panel_geninf, 'style', 'Text', ...
    'String', 'Mission ID', ...
    'units', 'normalized', ...
    'position', [0.41 0.8 0.34 0.1]);

id_mission = uicontrol(panel_geninf, 'style', 'edit', ...
    'units', 'normalized', ...
    'position', [0.53 0.6 0.1 0.15], ...
    'tag', 'IDMISSION_ENTER', ...
...
num_station = uicontrol(panel_geninf, 'style', 'edit', ...
    ...
    'TooltipString', '''XXX'' or ''XXX - XXX'' for multiple files', ...
...
% Option for skip over scan
msg = sprintf('%s\n%s', ...
    'Used in particular case if CTD was turned on before surface soak','Could also be removed with DataProcessing parameters');

uicontrol(panel_CTD, 'style', 'Text', ...
    'units', 'normalized', ...
    'string', 'Scan to Skip over', ...
    'TooltipString', msg, ...
    'position', [0.2 0.05 0.45 0.13]);

ScanToSkip_ctd = uicontrol(panel_CTD, 'style', 'edit', ...
    'units', 'normalized', ...
    'BackgroundColor', 'white', ...
    'position', [0.23 0.05 0.1 0.12], ...
    'TooltipString', '0 by default', ...
    'tag', 'SKANTOSKIP_ENTER', ...
    'string', '0');
